...
<head>
    ...
    <style>
        ...
        .sidebar-link:hover,.sidebar-link.active{background:rgba(62,42,0,.12);color:#3e2a00;font-weight:600}
...
<div class="row">
    <div class="col-md-2 sidebar-col vh-100 shadow-sm pt-3" style="min-height:100vh; background:linear-gradient(180deg,#f9e45b,#d4af37);">
        ...
        <a href="pembayaran.php" class="sidebar-link active">💳 Riwayat Pembayaran</a>
    ...
    <div class="col-md-10 p-4">
        ...
        <p class="text-muted mb-4">
            ...
            <a href="pembayaran.php" style="color:#d4af37;font-weight:600">← Lihat semua pembayaran</a>
            <?php else: ?>
                ...
                <table class="table mb-0">
                    ...
                    <?php if ($list && $list->num_rows > 0):
                        ...
                        <tr>
                            ...
                            <td class="fw-bold" style="color:#8a6d00"><?= formatRupiah($r['jumlah_bayar']) ?></td>
                            <td><?= formatRupiah($r['harga_jual']) ?></td>
                            <td><span class="badge" style="<?= $r['status_pesan']==='lunas'?'background:#d4af37;color:#3e2a00':'background:#fdd835;color:#3e2a00' ?>"><?= ucfirst($r['status_pesan']) ?></span></td>
                        </tr>
                    <?php endwhile; else: ?>
