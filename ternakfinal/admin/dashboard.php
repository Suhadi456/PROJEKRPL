...
$role_badge = ['admin'=>'danger','pemilik'=>'primary','user'=>'warning'];
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <style>
        ...
        .sidebar-link:hover,.sidebar-link.active{background:#fffde7;color:#3e2a00;font-weight:700}
...
<div class="row">
    ...
    <?php if ($_SESSION['role'] !== 'admin'): ?>
        <a href="../index.php" class="sidebar-link">🐄 Buka Panel Manajemen Pemilik</a>
    <?php endif; ?>
    ...
    <div class="col-md-10 p-4">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-6 col-md-3"><div class="stat-card"><div class="value" style="color:#d4af37"><?= $total_sapi ?></div><div class="text-muted">Total Sapi</div></div></div>
            ...
            <div class="col-6 col-md-3"><div class="stat-card"><div class="value" style="font-size:1.2rem;color:#d4af37"><?= formatRupiah($total_bayar) ?></div><div class="text-muted">Total Pembayaran</div></div></div>
        </div>
