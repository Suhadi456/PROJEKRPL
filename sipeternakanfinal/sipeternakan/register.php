...
<head>
    ...
    <style>
        body { background: linear-gradient(135deg, #1a4a2e 0%, #0e3320 50%, #0f1923 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center; font-family: 'Segoe UI', sans-serif; padding: 20px 0; }
        .card { border-radius: 16px; border: none; box-shadow: 0 20px 60px rgba(0,0,0,0.4); width: 100%; max-width: 440px; }
        .card-header { background: #1a4a2e; color: #fff; border-radius: 16px 16px 0 0 !important; text-align: center; padding: 24px; }
        .card-header h1 { font-size: 1.6rem; font-weight: 800; margin: 0; }
        .btn-daftar { background: #1a4a2e; color: #fff; border: none; width: 100%; padding: 12px; font-weight: 600; border-radius: 8px; }
        .btn-daftar:hover { background: #2d6a44; color: #fff; }
        .form-control:focus { border-color: #1a4a2e; box-shadow: 0 0 0 3px rgba(26,74,46,.2); }
    </style>
</head>
<body>
<div class="card">
    ...
    <div class="card-body p-4">
        ...
        <div class="text-center mt-3" style="font-size:.9rem">
            Sudah punya akun? <a href="login.php" class="fw-semibold text-success">Login di sini</a>
        </div>
    </div>
</div>
