...
<head>
    ...
    <style>
        body { background: linear-gradient(135deg, #1a4a2e 0%, #0e3320 50%, #0f1923 100%); min-height: 100vh; display: flex; align-items: center; justify-content: center; font-family: 'Segoe UI', sans-serif; }
        ...
        .login-brand h1 { font-size: 1.8rem; font-weight: 800; color: #1a4a2e; margin: 0; }
        ...
        .btn-login { background: #1a4a2e; color: #fff; border: none; width: 100%; padding: 12px; font-weight: 600; border-radius: 8px; font-size: 1rem; }
        .btn-login:hover { background: #2d6a44; color: #fff; }
        .register-link { text-align: center; margin-top: 20px; font-size: 0.9rem; }
        .register-link a { color: #1a4a2e; font-weight: 600; }
