...
<div class="row">
    ...
    <div class="col-md-10 p-4">
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-start mb-3">
                            ...
                            <span class="badge bg-<?= $pbadge[$r['status']] ?? 'secondary' ?> fs-6"><?= ucfirst($r['status']) ?></span>
                        </div>
                        <div class="row g-2" style="font-size:.9rem">
                            ...
                            <div class="col-6"><span class="text-muted">Total Dibayar:</span><br><strong class="text-success"><?= formatRupiah($r['total_bayar']) ?></strong></div>
                        ...
                        <?php endif; ?>
                        <a href="pembayaran.php?id_pesan=<?= $r['id'] ?>" class="btn btn-outline-success btn-sm mt-3">
        ...
        <div class="text-center py-5">
            ...
            <a href="sapi.php" class="btn btn-success mt-2">🐄 Lihat Katalog Sapi</a>
        </div>
        <?php endif; ?>
    </div>
</div>
