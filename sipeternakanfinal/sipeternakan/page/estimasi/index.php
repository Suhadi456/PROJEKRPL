...
<div class="stats-grid" style="margin-bottom:20px">
    ...
    <div class="stat-card" style="<?= $estimasi_untung>=0?'border-left:4px solid #2e7d32':'border-left:4px solid #c62828' ?>">
        ...
        <div>
            ...
            <div class="stat-value" style="font-size:1rem;color:<?= $estimasi_untung>=0?'#2e7d32':'#c62828' ?>"><?= formatRupiah(abs($estimasi_untung)) ?></div>
        ...
        <table class="data-table">
            ...
            ?>
                <tr>
                    ...
                    <td>
                        <?php if ($harga_jual > 0): ?>
                        <span style="font-weight:600;color:<?= $est_untung>=0?'#2e7d32':'#c62828' ?>">
