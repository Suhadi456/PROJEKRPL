        ...
        if (!$id_pesan || !$tgl || !$jumlah || !$jenis) {
            ...
            if ($jumlah > $sisa) {
                ...
                if ($total_baru >= $pesan['harga_jual']) {
                    ...
                    $msg = 'Pembayaran DP berhasil dicatat. Sisa: ' . formatRupiah($pesan['harga_jual'] - $total_baru);
                }
            }
        }
    }
...
<div class="page-header">
    <div class="page-header-left">
        ...
        <h1>💳 Pembayaran</h1>
        <p>Kelola pembayaran pemesanan sapi</p>
    </div>
</div>
...
<div class="alert" style="background:#e3f2fd;border-left:4px solid #1565c0;padding:12px 20px">
    📋 Menampilkan pembayaran untuk Pemesanan #<?= $id_pesan_filter ?> — <a href="index.php?page=pembayaran">Tampilkan Semua</a>
</div>
<?php endif; ?>

<!-- Daftar Pemesanan & Bayar -->
    ...
    <div class="table-responsive">
        <table class="data-table">
            ...
            <?php if ($riwayat_bayar && $riwayat_bayar->num_rows > 0):
                $no=1; $jenis_badge=['dp'=>'badge-amber','pelunasan'=>'badge-green','cicilan'=>'badge-blue'];
    ...
    <div class="modal-box">
        ...
        <form method="POST">
            ...
            <div class="modal-body">
                <div id="modal_info" style="background:#e8f5e9;border-radius:8px;padding:12px;margin-bottom:16px;font-size:.9rem"></div>
                <div class="form-grid">
